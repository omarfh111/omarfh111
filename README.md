...
<img src="assets/pipe-lineage-gradient.svg" alt="LineageGuard flow: request, retrieval, live DataHub evidence, deterministic impact analysis, independent review, human approval and scoped write-back" width="100%" />
...
<img src="assets/pipe-barons-gradient.svg" alt="BaronsMarket flow: mobile and employee interfaces, FastAPI orchestration, computer vision and RAG services, operational results" width="100%" />
...
<img src="assets/pipe-gabesi-gradient.svg" alt="Gabesi AIGuardian flow: live and scientific evidence, specialist modules, guardrails, deterministic models and operator-facing decisions" width="100%" />
